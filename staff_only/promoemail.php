...
<div id='emailbody' style='width: 60%;
  margin: auto;
  ...
  <div id='navbar' style='border: 2px solid blue;
  padding: 5%;'>
    <table style='border-bottom: 2px solid black;
  width: 100%;'><th><a href='' style='color: black;
  text-decoration: none;'>Therapy</a></th><th><a href='' style='color: black;
  text-decoration: none;'>Training</a></th><th><a href='' style='color: black;
  text-decoration: none;'>Events/Activities</a></th></table>
  </div>
  ...
  padding: 5%;'>
    <div id='poster' style='display: flex;
  border: 1px solid red;
  padding: 2%;
  flex-flow: column wrap;'>
      <img src='CSS/images/(1).png' alt='(1).png' style='max-width: 100%;'>
    </div>
    <div id='posterbody' style='border: 1px solid turquoise;
  width: 100%;
  justify-items: center;'>
      <p>This is a really enlightening experience. You should check it out</p>
    </div>
    <div id='list' style='border: 1px solid purple;
  padding: 2%;
  display: flex;
  flex-wrap: wrap;
  justify-content: space-evenly;
  width: 100%;'>
      <section class='eventpart' style='display: flex;
  ...
  box-sizing: border-box;'>
        ...
        <section class='readmore'>
            <a href=''><button class='morebutton' style='background-color: #0056b3;
  color: #ffffff;
  border: none;
  padding: 10px 20px;
  border-radius: 4px;
