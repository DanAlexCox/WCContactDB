...
include('connectdb.php');
        if(isset($_POST['registerbtn'])) {
            ...
            $new_privilege = $_POST['new_permissions'];
            ...
            if (!preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&:])([A-Za-z\d@$!%*?&:)]{8,})$/', $new_password)) {
                ...
                if($existing_user == 0) {
                    $create_query = "INSERT INTO `staff_user` (staff_email, username, password, Privilege) VALUES (:se, :us, :pa, :pv)";
                    ...
                    $create_stmt->bindParam(':pv', $new_privilege);
