...
--
-- Table structure for table `attendstatus`
--

CREATE TABLE `attendstatus` (
  `Status_ID` int(11) NOT NULL,
  `StatusName` varchar(255) NOT NULL COMMENT 'Status: Booked, Completed, Cancelled',
  `Created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `Updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `attendstatus`
--

INSERT INTO `attendstatus` (`Status_ID`, `StatusName`, `Created_at`, `Updated_at`) VALUES
(1, 'Booked', '2025-01-20 11:33:04', '2025-01-20 11:33:04'),
(2, 'Completed', '2025-01-20 11:33:04', '2025-01-20 11:33:04'),
(3, 'Cancelled', '2025-01-20 11:33:04', '2025-01-20 11:33:04');
...
CREATE TABLE `clientreport` (
  `ClientReport_ID` int(11) NOT NULL,
  `Client_ID` int(11) NOT NULL,
  `Symptom_ID` int(11) DEFAULT NULL,
  `Treatment_ID` int(11) DEFAULT NULL,
  `Status_ID` int(11) NOT NULL DEFAULT 1,
  `Description` varchar(255) DEFAULT NULL,
  `ScheduleDate_at` timestamp NULL DEFAULT NULL,
  `Created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `Updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `clientreport` (`ClientReport_ID`, `Client_ID`, `Symptom_ID`, `Treatment_ID`, `Status_ID`, `Description`, `ScheduleDate_at`, `Created_at`, `Updated_at`) VALUES
(1, 1, 1, 1, 1, NULL, NULL, '2025-01-16 11:29:31', '2025-01-16 11:29:31'),
(2, 2, 5, 7, 1, NULL, NULL, '2025-01-16 11:29:31', '2025-01-16 11:29:31'),
(3, 1, 1, 1, 1, 'sgvdsf', NULL, '2025-01-16 12:08:18', '2025-01-16 12:08:18'),
(4, 2, 6, 7, 1, 'This is a report', '2025-01-21 10:00:00', '2025-01-20 11:23:44', '2025-01-20 11:23:44');
...
(1, 'adala738@gmail.com', 'Mr', 'Daniel', 'Cox', 'Male', 24, 'Christianity', '2024-12-12 00:00:00', '2025-01-16 11:37:28'),
(3, '210200410@aston.ac.uk', 'Prof', 'Johnny', 'Doe', 'Male', 30, 'Judaism', '2024-12-12 00:00:00', '2025-01-15 16:18:16'),
(4, 'Daniel@womensconsortium.org.uk', 'Mr', 'Danny', 'Coxxy', 'Male', 20, 'Atheism', '2025-01-16 11:20:30', '2025-01-16 11:20:30');
...
INSERT INTO `clinic_user` (`ClinicUser_ID`, `Username`, `Password`, `Email`, `Created_at`, `Updated_at`) VALUES
...
(9, 'fsdg', 'sdgsdg', '2024-12-19', 0, 'Mrs sdfv sdgf', '210200410@aston.ac.uk', '2024-12-19 21:34:53', '2024-12-19 21:34:53');
...
(1, 'Daniel@womensconsortium.org.uk', 'DanielCox', '$2y$10$f4oV7ZKKnCk4SV7Zxlv.4eoB/CeWZ1hs0LqX9lWy3qZALQrOklwui', 'VCM', '2024-12-12 14:01:47', '2024-12-16 13:48:21'),
(8, 'adala738@gmail.com', 'daniel_cox', '$2y$10$/BpS6c1/9pSzmhBOG1i5e.RBTULwhvdv7ZrTGC8xSGmaeGVvTvJjm', 'V', '2024-12-16 15:15:34', '2024-12-16 16:08:41');
...
(4, 'Personality Disorders', '2024-12-12 14:01:58', '2025-01-13 13:38:19'),
...
INSERT INTO `symptomsubgroups` (`SymptomSubgroup_ID`, `Name`, `Created_at`, `Updated_at`) VALUES
...
--
-- Indexes for table `attendstatus`
--
ALTER TABLE `attendstatus`
  ADD PRIMARY KEY (`Status_ID`);

--
-- Indexes for table `clientreport`
--
ALTER TABLE `clientreport`
  ADD PRIMARY KEY (`ClientReport_ID`);
...
ALTER TABLE `symptomsubgroups`
  ADD PRIMARY KEY (`SymptomSubgroup_ID`);
...
--
-- AUTO_INCREMENT for table `attendstatus`
--
ALTER TABLE `attendstatus`
  MODIFY `Status_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `clientreport`
--
ALTER TABLE `clientreport`
  MODIFY `ClientReport_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `clinic_user`
  MODIFY `ClinicUser_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `symptomsubgroups`
  MODIFY `SymptomSubgroup_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
